...
<body>
    ...
    <div class="container">
        <div class="about-us-container">
            ...
            <!-- === NEW: HERO IMAGE SECTION === -->
            <!-- Just change the 'src' to your image path. A wide image (like 1200x450 pixels) works best here. -->
            <div class="about-hero-image-container">
                <img src="img/about.jpg" alt="A vibrant kitchen scene or a picture of your team">
            </div>
            ...
            <div class="team-grid">
                ...
                <div class="team-member">
                    <div class="team-member-header"></div>
                    <img src="img/shamimi.jpg" alt="Nurfatin Shamimi Binti Roosly">
                    <div class="team-member-body">
