...
// --- PHP logic to fetch data (this part is already correct from your previous version) ---
$available_cuisines = [];
...
<head>
    ...
    <style>
        ...
        /* === NEW STYLES FOR USER INFO IN NAVBAR === */
        .user-info {
            display: flex;
...
<body>
        ...
        <div class="nav-container">
            ...
            <div class="nav-links">
                ...
                <?php if(isset($_SESSION["loggedin"])): ?>
                    <!-- === MODIFIED BLOCK FOR LOGGED-IN USER === -->
    ...
    <!-- The SCRIPT and FOOTER sections remain the same -->
    <script>
        // Your voice search script
    </script>
    <footer class="footer">
