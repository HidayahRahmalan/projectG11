...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav-menu">
            <li class="nav-item">
                <a href="staff_dashboard.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'home.php' ? 'active' : ''; ?>">
                    <i class="nav-icon bi bi-house"></i>
                    <span class="nav-text">Dashboard</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="report_management.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'view_reports.php' ? 'active' : ''; ?>">
            ...
            <li class="nav-item">
                <a href="staff_profile1.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'staff_profile1.php' ? 'active' : ''; ?>">
